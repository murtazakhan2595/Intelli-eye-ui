  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex justify-between items-center px-5 font-medium tracking-wide whitespace-nowrap w-full max-md:flex-wrap">
        ...
        <div className="justify-center self-stretch px-9 py-3.5 my-auto text-lg leading-6 text-indigo-600 rounded-xl border-2 border-indigo-600 border-solid shadow-lg max-md:px-5">
          Subscribe
        </div>
      </div>
    </div>
