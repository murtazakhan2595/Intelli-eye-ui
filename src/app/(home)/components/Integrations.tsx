...
export default function Integrations() {
  return (
    <div className="mt-6 flex flex-col justify-center items-center gap-[90px]">
      ...
      <div className="flex items-start justify-center gap-[204px]">
        ...
        <div className="w-[675.77px] h-[1013px] relative">
          ...
          <div className="w-[70.05px] h-[70.05px] left-[-0px] top-[293.38px] absolute">
            <div className="w-[70.05px] h-[70.05px] left-0 top-0 absolute bg-indigo-600 rounded-full" />
            <div className="left-[29.67px] top-[20.60px] absolute text-white text-[28.02px] font-medium ">
              2
            </div>
          </div>
          <div className="w-[70.05px] h-[70.05px] left-[-0px] top-[567.81px] absolute">
            <div className="w-[70.05px] h-[70.05px] left-0 top-0 absolute bg-indigo-600 rounded-full" />
            <div className="left-[29.67px] top-[20.60px] absolute text-white text-[28.02px] font-medium ">
              3
            </div>
          </div>
          <div className="w-[70.05px] h-[70.05px] left-[-0px] top-[802.68px] absolute">
            <div className="w-[70.05px] h-[70.05px] left-0 top-0 absolute bg-indigo-600 rounded-full" />
            <div className="left-[29.67px] top-[20.60px] absolute text-white text-[28.02px] font-medium ">
              4
            </div>
          </div>
          <div className="w-[502.70px] h-[228.28px] left-[173.06px] top-[20.60px] absolute flex-col justify-start items-start gap-[19.78px] inline-flex">
          ...
          <div className="w-[502.70px] h-[188.72px] left-[173.06px] top-[313.98px] absolute flex-col justify-start items-start gap-[19.78px] inline-flex">
          ...
          <div className="w-[502.70px] h-[149.16px] left-[173.06px] top-[588.41px] absolute flex-col justify-start items-start gap-[19.78px] inline-flex">
